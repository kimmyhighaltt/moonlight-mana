  ...
  const renderCard = (item) => {
    ...
    return (
      <div key={item.id} className="flex flex-col gap-2">
        ...
        {/* --- THE TENACIOUS BLOG SECTION (Expansion) --- */}
        {isExpanded && (
          <div className="animate-in slide-in-from-top-2 duration-300 bg-slate-950/80 border border-amber-200/20 rounded-2xl p-6 mx-2 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 text-sm leading-relaxed font-light mb-4 whitespace-pre-wrap">
        ...
        {Object.keys(categories).map((key) => {
          ...
          return (
            <button
              ...
              className={`whitespace-nowrap flex items-center gap-2 px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${
                isActive 
